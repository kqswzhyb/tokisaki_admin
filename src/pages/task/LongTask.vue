<template>
  <div class="q-pa-md" style="width: 100%;">
    <div style="margin-bottom:20px;" @click="$router.push('/notice/2')">
      <span class="text-h6 main">众筹</span>
    </div>
    <div style="margin-bottom:20px;">
      ...
      <div class="text-weight-medium">
        本次任务终止时间: 2020.02.21 09:00:00
      </div>
    </div>

    <q-list>
      <q-expansion-item group="somegroup" icon="explore" label="First" popup>
        <template v-slot:header>
          <q-item style="width: 100%;">
            ...
            <q-item-section>
              ...
              <q-item-label caption>获得积分：10</q-item-label>
            </q-item-section>
          </q-item>
        </template>
        <q-card>
          <q-item>
            <q-item-section top>
              <q-item-label lines="1">
                <span class="text-weight-medium">QQ：465604612</span>
              </q-item-label>
            </q-item-section>
            <q-item-section top>
              <q-item-label lines="1">
                <span class="text-weight-medium">身份：组长</span>
              </q-item-label>
            </q-item-section>
          </q-item>
          <q-item>
      ...
      <q-expansion-item group="somegroup" icon="bluetooth" label="Fourth" popup>
        <q-card>
          <q-card-section>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem,
            eius reprehenderit eos corrupti commodi magni quaerat ex numquam,
